...
const zh: Dict = {
  ...
  "community.upload.title": "上传谱子",
  "community.upload.target_personal": "我的仓库（直接提交）",
  "community.upload.target_community": "社区仓库（Fork + PR）",
  "community.upload.message_label": "提交信息",
  "community.upload.message_placeholder": "描述你的变更",
  "community.upload.submit": "上传",
  "community.upload.uploading": "上传中…",
  "community.upload.success": "上传成功！",
  "community.upload.pr_created": "PR 已创建：",
  "community.upload.error": "上传失败：",
...
const en: Dict = {
  ...
  "community.upload.title": "Upload score",
  "community.upload.target_personal": "My repo (direct commit)",
  "community.upload.target_community": "Community repo (Fork + PR)",
  "community.upload.message_label": "Commit message",
  "community.upload.message_placeholder": "Describe your change",
  "community.upload.submit": "Upload",
  "community.upload.uploading": "Uploading…",
  "community.upload.success": "Uploaded!",
  "community.upload.pr_created": "PR created: ",
  "community.upload.error": "Upload failed: ",
