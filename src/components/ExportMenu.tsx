      ...
      trigger={({ open }) => (
        <span
          ...
          className={cn(
            ...
            status === "error"
              ? "border-red-300 bg-red-50 text-red-700 dark:bg-red-900 dark:text-red-100"
              : status === "pending"
                ? "border-amber-300 bg-amber-50 text-amber-800 dark:bg-amber-900 dark:text-amber-100"
                : open
