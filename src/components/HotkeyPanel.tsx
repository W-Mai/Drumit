  ...
  const sections: SectionData[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { keys: [","], label: t("hotkeys.split_group") },
        { keys: ["<"], label: t("hotkeys.merge_group") },
        { keys: ["+", "="], label: t("hotkeys.add_slot") },
        { keys: ["_"], label: t("hotkeys.remove_slot") },
        { keys: ["|"], label: t("hotkeys.double_slots") },
        { keys: ["\\"], label: t("hotkeys.halve_slots") },
