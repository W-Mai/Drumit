...
describe("beam merging across groups", () => {
  ...
  it("regression: `cr/hh/bd/sn/ft` dotted+split multi-lane bar — exact beam snapshot", () => {
    ...
    expect(snapshot).toEqual([
      [{ rowGroup: "kick", depth: 1, x1: 29, x2: 79.4, y: 146 }],
      [
        { rowGroup: "kick", depth: 2, x1: 107.6, x2: 131.8, y: 149 },
        { rowGroup: "kick", depth: 1, x1: 81.4, x2: 131.8, y: 146 },
      ],
      [
        { rowGroup: "kick", depth: 2, x1: 133.8, x2: 158, y: 149 },
        { rowGroup: "kick", depth: 1, x1: 133.8, x2: 184.2, y: 146 },
      ],
      [{ rowGroup: "snare", depth: 1, x1: 186.2, x2: 236.6, y: 146 }],
    ]);
  });
  ...
  it("regression: dotted 8th + 16th (o.o) — exact beam snapshot", () => {
    ...
    expect(snap).toEqual([
      [
        { rowGroup: "cymbals", depth: 2, x1: 65.2, x2: 75.3, y: 125 },
        { rowGroup: "cymbals", depth: 1, x1: 29, x2: 75.3, y: 122 },
      ],
      [{ rowGroup: "cymbals", depth: 1, x1: 77.3, x2: 123.5, y: 122 }],
      [{ rowGroup: "cymbals", depth: 1, x1: 125.5, x2: 171.8, y: 122 }],
      [{ rowGroup: "cymbals", depth: 1, x1: 173.8, x2: 220, y: 122 }],
    ]);
  });
